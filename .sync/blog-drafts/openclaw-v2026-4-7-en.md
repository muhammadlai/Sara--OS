...
A: Yes — add the plugin config to `openclaw.json` with a strong HMAC secret. See the [TOOLS.md webhook section](https://github.com/muhammadlai/Sara--OS/blob/main/workspace/TOOLS.md) for the full config block.
...
**[Start free on AITZAZ AI →](https://pulseagent.io/app/login?ref=blog&utm_source=blog&utm_medium=release-post&utm_campaign=openclaw-v2026-4-7)**
