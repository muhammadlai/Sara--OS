...
A：需要。将插件配置添加到`openclaw.json`，设置HMAC密钥。完整配置参见[TOOLS.md Webhook章节](https://github.com/muhammadlai/Sara--OS/blob/main/workspace/TOOLS.md)。
...
**[免费开始使用 AITZAZ AI →](https://pulseagent.io/app/login?ref=blog&utm_source=blog&utm_medium=release-post&utm_campaign=openclaw-v2026-4-7)**
