...
Open a [GitHub Issue](https://github.com/muhammadlai/Sara--OS/issues) with:
- Steps to reproduce
...
Pull requests run the same `npm test` checks via the GitHub Actions workflow (see [`docs/ci-validate.yml`](./docs/ci-validate.yml)).
