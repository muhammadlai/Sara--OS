# AITZAZ AI 2070 — Template de Agente SDR B2B
...
|--------|--------|-------------|
| `b2b_trade` | 41 skills | Empresas de exportação B2B (padrão) |
...
### Painel AITZAZ AI 2070

O repositório inclui um painel futurista de sistema operacional de IA (`dashboard/`). Ele mostra dados gerados dos arquivos reais do projeto (camadas do workspace, skills, KB de produtos, validação) — sem dados fictícios; capacidades inexistentes são marcadas como fases futuras.

```bash
npm run dashboard   # regenera dashboard/data.json
