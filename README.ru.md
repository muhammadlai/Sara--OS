...
|---------|--------|----------|
| `b2b_trade` | 41 skills | B2B экспортные компании (по умолчанию) |
...
### Панель AITZAZ AI 2070

Репозиторий поставляется с футуристичной панелью AI-ОС (`dashboard/`). Она показывает данные, сгенерированные из реальных файлов проекта (слои workspace, навыки, KB продуктов, результаты проверки) — без фиктивных данных; отсутствующие возможности помечены как будущие фазы.

```bash
npm run dashboard   # пересобрать dashboard/data.json
