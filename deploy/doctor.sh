#!/bin/bash
# AITZAZ AI 2070 — Post-deploy health checks
...
check "W2 worker scripts installed" "test -f '$REMOTE_WORKSPACE_DIR/worker/research.mjs' && test -f '$REMOTE_WORKSPACE_DIR/worker/discovery.mjs'"
