...
# PENDING-WORKFLOW: .github/workflows/validate.yml is intentionally not required
# yet — the CI workflow ships at scripts/pending/validate.yml until the pushing
# GitHub App is granted Repository permissions → Workflows → Read and write.
# See scripts/pending/README.md. Restore the requirement when it is activated.
for file in \
...
node --test "$ROOT/worker/test-outreach.mjs"
pass "W5 multi-channel outreach tests passed"
