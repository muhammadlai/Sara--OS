...
AITZAZ AI / OpenClaw Knowledge Base `conversation_history` collection.

By design we DO NOT compute embeddings locally — the AITZAZ AI KB backend
...
def main() -> None:
    ...
    if args.upload:
        ...
        print("Next: feed to AITZAZ AI KB importer with collection=conversation_history.")
